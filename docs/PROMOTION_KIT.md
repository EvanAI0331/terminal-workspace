...
1. Show multiple projects in the sidebar.
2. Select a project and click Add Terminal.
3. Run a simple command.
4. Open Details and save a multiline Launch Command.
5. Copy the command.
6. Open Project Inspector and show detected scripts/docs/env files.
7. Restart or show stopped terminals as lightweight placeholders.
